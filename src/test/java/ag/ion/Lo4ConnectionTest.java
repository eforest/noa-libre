...
public class Lo4ConnectionTest {
    ...
    static {
        configuration.put( IOfficeApplication.APPLICATION_HOME_KEY, TestProperties.getLibreOfficePath() );
    ...
    public static void main(String[] args) {
        ...
        try {
            OfficeLoader.run( new String[] { "ag.ion.Lo4ConnectionTest$Lo4ConnectionTestCore" } );
        }
        catch ( Exception e ) {
            e.printStackTrace();
        }
        ...
        public static void main(String[] args) {
            ...
            try {
                ...
                com.sun.star.frame.XComponentLoader xCompLoader =
                    (com.sun.star.frame.XComponentLoader) com.sun.star.uno.UnoRuntime
                                                                                     .queryInterface(
                                                                                         com.sun.star.frame.XComponentLoader.class,
                                                                                         oDesktop );
                com.sun.star.lang.XComponent xComponent = xCompLoader
                ...
                com.sun.star.document.XEventBroadcaster xEventBroadcaster =
                    (com.sun.star.document.XEventBroadcaster) com.sun.star.uno.UnoRuntime
                                                                                         .queryInterface(
                                                                                             com.sun.star.document.XEventBroadcaster.class,
                                                                                             xComponent );
