...
public class ITextTableCellPropertiesTest extends TestCase {
    ...
    public void testGetBackgroundColor() {
        ...
        // (TextDocument)TextDocumentFactory.createTextDocument(localOfficeConnection.getXMultiComponentFactory(),
        // localOfficeConnection.getXComponentContext());
        //
        ...
        // ICharacterProperties characterProperties =
        // cell.getTextService().getText().getTextCursorService().getTextCursor().getCharacterProperties();
    ...
    public void testGetParagraphs() {
        ...
        // textTable.getCell("A2").getTextService().getText().getTextContentEnumeration().getParagraphs();
