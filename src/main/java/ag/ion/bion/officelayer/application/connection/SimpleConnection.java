...
public class SimpleConnection {
        ...
        if ( host != null && port > 0 ) {
            ...
            try {
                ...
                try {
                    ...
                    Logger
                          .getLogger( SimpleConnection.class.getName() )
    ...
    public synchronized static void startOOServerIfNotRunning(final String path, final int port) {
        ...
        final String command = path.replace( "\\", "\\\\" ) + File.separator
            + props.getProperty( "OFFICE_BINARY_FOLDER" ) + File.separator + "soffice" + " " + "-headless" + " "
            + "-nofirststartwizard" + " " + "-norestore" + " " + "-nolockcheck" + " " + "-nocrashreport" + " "
            + "-nodefault" + " " + "-accept='socket,host=0.0.0.0,port=" + port + ";urp;StarOffice.Service'";
