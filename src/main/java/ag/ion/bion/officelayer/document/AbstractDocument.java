...
public abstract class AbstractDocument implements IDocument {
    ...
    public AbstractDocument(XComponent xComponent, PropertyValue[] initialProperties) throws IllegalArgumentException {
        ...
        documentListenerWrapper = new DocumentListenerWrapper( new DocumentListener(), getServiceProvider() );
    ...
    public IFormService getFormService() {
        XDrawPageSupplier drawPageSupplier =
            ( (XDrawPageSupplier) UnoRuntime.queryInterface( XDrawPageSupplier.class, xComponent ) );
    ...
    public void addDocumentModifyListener(IDocumentModifyListener documentModifyListener) {
        DocumentModifyListenerWrapper documentListenerWrapper =
            ...
            new DocumentModifyListenerWrapper( documentModifyListener, getServiceProvider() );
        ...
        if ( modifyListenerTable != null ) {
            if ( modifyListenerTable.containsKey( documentModifyListener ) ) {
                DocumentModifyListenerWrapper documentModifyListenerWrapper =
                    (DocumentModifyListenerWrapper) modifyListenerTable.get( documentModifyListener );
    ...
    public boolean isModified() {
        ...
        // }
        /**
         * We do not use the XModifiable interface because it can cause a deadlock in Multi-Thread Enviroments.
         */
        return isModified;
    }
     ...
     * 
     * @param closeListener close listener Andreas Bröker
     */
    public void addCloseListener(ICloseListener closeListener) {
        ...
        if ( xCloseable != null ) {
            CloseListenerWrapper closeListenerWrapper = new CloseListenerWrapper( closeListener, getServiceProvider() );
    ...
    public void close() {
        long millis = 50l;
        /*
         * geht nur für Writer und nicht für alle anderen.... XRefreshable refresh = null; refresh =
         * (XRefreshable)UnoRuntime.queryInterface(XRefreshable.class, xComponent); refresh.refresh();
         */
            ...
            try {
                ...
                if ( xModel != null ) {
                    ...
                    com.sun.star.util.XModifiable xModify =
                        (com.sun.star.util.XModifiable) UnoRuntime
                                                                  .queryInterface(
                    ...
                    com.sun.star.frame.XController xController =
                        (com.sun.star.frame.XController) UnoRuntime
                                                                   .queryInterface(
    ...
    private void addEventListener(XEventListener xEventListener) {
        XEventBroadcaster xEventBroadcaster =
            (XEventBroadcaster) UnoRuntime.queryInterface( XEventBroadcaster.class, xComponent );
    ...
    public void fireDocumentEvent(String documentEventName) {
        ...
        IDocumentEvent documentEvent =
            new DocumentEvent( new EventObject( getXComponent(), documentEventName ), getServiceProvider() );
    ...
    protected void setXInterfaceObjectSelection(IXInterfaceObjectSelection interfaceObject) throws NOAException {
        ...
        if ( xModel != null ) {
            ...
            XSelectionSupplier selectionSupplier =
                (XSelectionSupplier) UnoRuntime.queryInterface( XSelectionSupplier.class, xController );
