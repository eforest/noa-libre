...
public interface IDocumentService extends IDisposeable {
     ...
     * document is already open - therefore the document will be never opened in <code>ReadOnly</code> mode.</b>
     * 
     ...
     *             or the submitted frame is not valid
     * @author Andreas Bröker
     */
