...
/**
 * "Construct" to store the properties of a table cell, so that even when deleteing the original cell (and thus loosing
...
public class TextTableCellPropertyStore extends AbstractPropertyStore implements ITextTableCellPropertyStore {
     ...
     * 
     * @param cell cellXPropertySet the propertyset of the cell whose properties should be stored
     * @author Sebastian Rösgen
     */
     ...
     * 
     * @param cell xPropertySet the properties that shuld be analysed and stored.
     * @author Sebastian Rösgen
     * @author Markus Krüger
     */
