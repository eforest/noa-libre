...
public class LocalOfficeConnection extends AbstractOfficeConnection {
    ...
    public boolean openConnection(IOfficeProgressMonitor officeProgressMonitor) throws Exception {
        ...
        /**
         * This is only a hook, on the basis of modified OpenOffice.org Java libraries jurt.jar and officebean.jar, in
         * order to use a specified path to load native OpenOffice.org libraries. Due to the BETA status of
         * OpenOffice.org 2.0 it is not necessary to construct a final solution. We will wait for the final release ...
         */
        try {
            if ( officeProgressMonitor != null ) {
                officeProgressMonitor
                                     .beginTask(
                                         Messages
                                                 .getString(
                                                     "LocalOfficeConnection_monitor_office_application_message" ), //$NON-NLS-1$
                                         5 );
    ...
    public XMultiServiceFactory getXMultiServiceFactory() throws Exception {
        return (XMultiServiceFactory) UnoRuntime
                                                .queryInterface(
            ...
            try {
                ...
                XToolkit xToolkit =
                    (XToolkit) UnoRuntime
                                         .queryInterface(
                                             XToolkit.class,
                                             getXMultiServiceFactory().createInstance( "com.sun.star.awt.Toolkit" ) );
