...
public class DesktopService implements IDesktopService {
     ...
     * @throws IllegalArgumentException if the submitted OpenOffice.org XDesktop interface or the connection to
     *             OpenOffice.org is not valid
     * @author Andreas Bröker
     * @author Markus Krüger
     */
     ...
     * @author Markus Krüger
     */
    public DesktopService(XDesktop xDesktop, IOfficeConnection officeConnection, boolean preventTermination)
    ...
    IOfficeConnection getOfficeConnection() {
    ...
    public void addTerminateListener(ITerminateListener terminateListener) {
        ...
        TerminateListenerWrapper terminateListenerWrapper =
            new TerminateListenerWrapper( terminateListener, new ServiceProvider( officeConnection ) );
    ...
    public void removeTerminateListener(ITerminateListener terminateListener) {
        ...
        TerminateListenerWrapper terminateListenerWrapper =
            (TerminateListenerWrapper) terminateListeners.get( terminateListener );
    ...
    public void addDocumentListener(IDocumentListener documentListener) throws DesktopException {
        try {
            ...
            if ( eventBroadcaster == null ) {
                Object globalEventBroadcaster =
                    officeConnection
                                    .getXMultiServiceFactory()
                                    .createInstance( "com.sun.star.frame.GlobalEventBroadcaster" );
                eventBroadcaster =
                    (XEventBroadcaster) UnoRuntime.queryInterface( XEventBroadcaster.class, globalEventBroadcaster );
            }
            DocumentListenerWrapper documentListenerWrapper =
                new DocumentListenerWrapper( documentListener, new ServiceProvider( officeConnection ) );
    ...
    public void removeDocumentListener(IDocumentListener documentListener) {
        ...
        DocumentListenerWrapper documentListenerWrapper =
            (DocumentListenerWrapper) documentListeners.get( documentListener );
    ...
    // ----------------------------------------------------------------------------
    /**
     * Constructs new OpenOffice.org frame which is integrated into the submitted AWT container. This method works only
    ...
    // ----------------------------------------------------------------------------
    /**
     * Constructs new OpenOffice.org frame which uses the submitted native view. This method works only on local
