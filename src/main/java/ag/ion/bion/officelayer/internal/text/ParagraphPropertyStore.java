...
public class ParagraphPropertyStore extends AbstractPropertyStore implements IParagraphPropertyStore {
     ...
     * 
     * @param paraAdjust the value of the para adjust
     * @throws TextException if the para adjust is not valid
     * @author Sebastian Rösgen
     */
    public void setParaAdjust(short paraAdjust) throws TextException {
        if ( paraAdjust == IParagraphProperties.ALIGN_CENTER || paraAdjust == IParagraphProperties.ALIGN_LEFT
            || paraAdjust == IParagraphProperties.ALIGN_RIGHT || paraAdjust == IParagraphProperties.ALIGN_UNDEFINED ) {
    ...
    // ----------------------------------------------------------------------------
    /**
     * Reads the properties out of the submitted paragraph and thus fills the storage with the gained information.
     * 
