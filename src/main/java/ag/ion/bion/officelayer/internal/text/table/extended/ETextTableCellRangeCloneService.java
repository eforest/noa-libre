...
public class ETextTableCellRangeCloneService extends AbstractCloneService {
     ...
     * @author Miriam Sutter
     */
    public ETextTableCellRangeCloneService(IETextTableCellRange textTableCellRange, ITextDocument textDocument)
        ...
        try {
            ...
            if ( generateReturnValue ) {
                ITextTableCellRangeName textTableCellRangeName =
                    new TextTableCellRangeName( 0, 0, range[0].getColumnCount() - 1, range[0].getRowCount() );
