...
public class ETextTable implements IETextTable {
    ...
    public void addRows(int count) throws TextException {
        ITextTableCellRange textTableCellRangeClone =
            textTableManagement
                               .getLastTextTable()
                               .getCellRange(
                                   0,
    ...
    private void addRowsProperty(int count, ITextTableCellRange textTableCellRangeClone) throws TextException {
        try {
            ...
            if ( ( singleTableRowCount + count ) * columnCount <= ITextTable.MAX_CELLS_IN_TABLE ) {
                ...
                ITextTableCellRange textTableCellRangeHeaderClone =
                    textTableLast.getCellRange( 0, 0, columnCount - 1, 0 );
                ...
                while ( helpCount > 0 ) {
                    ...
                    TextTablePropertyStore tablePropertyStore =
                        new TextTablePropertyStore( textTableManagement.getFirstTextTable() );
    ...
    public void addRows(int index, int count) throws TextException {
        ...
        try {
            ETextTableCellRange tableCellRange =
                (ETextTableCellRange) textTableCellRange
                                                        .getCloneService()
                                                        .cloneToPosition( destinationPosition, null )
                                                        .getClonedObject();
            ...
            if ( help < 0 ) {
                ...
                IETextTableCellRange cellRange =
                    getCellRange( 0, index, columnCount - 1, index + ( rowCount - rowIndex ) );
                clearTableRange( cellRange );
    ...
    public IETextTableCell getCell(int rowIndex, int columnIndex) throws TextException {
        String cellName = TextTableCellNameHelper.getColumnCharacter( columnIndex )
    ...
    public IETextTableCell getCell(String cellName) throws TextException {
        ...
        ITextTableCell textTableCell =
            textTableManagement
                               .getTextTable( tableNumber )
     ...
     * @author Miriam Sutter
     */
    public IETextTableCellRange getCellRange(int firstColumnIndex, int firstRowIndex, int lastColumnIndex,
                                             int lastRowIndex)
        ...
        ITextTableCellRangeName tableCellRangeName =
            new TextTableCellRangeName( firstColumnIndex, firstRowIndex, lastColumnIndex, lastRowIndex );
     ...
     * 
     * @param rangeName name of the cell range
    ...
    private void cloneRange(ITextTable textTable, ITextTableCellRange textTableCellRange, int count,
        ...
        throws CloneException, TextException {
    ...
    public void removeRows(int index, int count) throws TextException {
        ...
        if ( help == 0 ) {
            ...
            textTableManagement
                               .getTextTable( tableNumber )
                               .removeRows(
                                   getRowIndexInTable( tableNumber, index ),
