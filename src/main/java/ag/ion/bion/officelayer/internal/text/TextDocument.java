...
public class TextDocument extends AbstractDocument implements ITextDocument {
     ...
     * @param zoomValue the value of the zoom, does only take afect if zoom type is set to DocumentZoomType.BY_VALUE.
     *            Values between 20 and 600 are allowed.
    ...
    public void zoom(short zoomType, short zoomValue) throws DocumentException {
        try {
            ...
            if ( zoomType != DocumentZoomType.BY_VALUE && zoomType != DocumentZoomType.ENTIRE_PAGE
                && zoomType != DocumentZoomType.OPTIMAL && zoomType != DocumentZoomType.PAGE_WIDTH
            ...
            if ( xModel != null ) {
                ...
                if ( selectionSupplier != null ) {
                    XViewSettingsSupplier viewSettingsSupplier =
                        (XViewSettingsSupplier) UnoRuntime.queryInterface( XViewSettingsSupplier.class, xController );
