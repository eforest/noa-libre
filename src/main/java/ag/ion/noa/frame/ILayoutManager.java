...
public interface ILayoutManager {
    ...
    public static String[] ALL_BARS_URLS = new String[] { URL_MENUBAR, URL_STATUSBAR, URL_TOOLBAR,
        URL_TOOLBAR_ALIGNMENTBAR, URL_TOOLBAR_ARROWSHAPES, URL_TOOLBAR_BASICSHAPES, URL_TOOLBAR_CALLOUTSHAPES,
        URL_TOOLBAR_DRAWBAR, URL_TOOLBAR_DRAWOBJECTBAR, URL_TOOLBAR_EXTRUSIONOBJECTBAR, URL_TOOLBAR_FONTWORKOBJECTBAR,
        URL_TOOLBAR_FONTWORKSHAPETYPES, URL_TOOLBAR_FORMATOBJECTBAR, URL_TOOLBAR_FORMCONTROLS, URL_TOOLBAR_FORMDESIGN,
        URL_TOOLBAR_FORMFILTERBAR, URL_TOOLBAR_FORMSNAVIGATIONBAR, URL_TOOLBAR_FORMSOBJECTBAR,
        URL_TOOLBAR_FORMSTEXTOBJECTBAR, URL_TOOLBAR_FULLSCREENBAR, URL_TOOLBAR_GRAPHICOBJECTBAR, URL_TOOLBAR_INSERTBAR,
        URL_TOOLBAR_INSERTCELLSBAR, URL_TOOLBAR_INSERTOBJECTSBAR, URL_TOOLBAR_MEDIAOBJECTSBAR,
        URL_TOOLBAR_MOREFORMCONTROLS, URL_TOOLBAR_PREVIEWBAR, URL_TOOLBAR_STANDARDBAR, URL_TOOLBAR_STARSHAPES,
